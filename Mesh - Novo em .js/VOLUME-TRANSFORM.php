...
<html>
  ...
  <body class="animsition" style="animation-duration: 700ms; opacity: 1;">
    <div class="section__content section__content--p30">
      ...
      <center><h2>Relatório de Dosagem Consumo por Volume</h2></center>
          <div class="row">
      ...
      #definição das propiedades de cada material
      ...
      <div class="container">
          <div class="col-md-12">
            ...
            <h4>Volume</h4>
            <p>Massa específica da água: <?php echo "<strong> $vc kg/dm³</strong>"; ?> </p><br>

            <h3>Traço com volume:</h3>
            <p> <?php echo "<strong> $cv1 : $av1 : $bv1 :$acv1 </strong>"; ?></p>
